...
const candleColors = ['#FF6B6B', '#FFB74D', '#4ECDC4', '#45B7D1', '#FFA07A']
const balloonColors = ['#FF6B6B', '#FFB74D', '#4ECDC4', '#45B7D1', '#FFA07A']
const confettiColors = ['#FF6B6B', '#FFB74D', '#4ECDC4', '#45B7D1', '#FFA07A', '#F7DC6F', '#BB8FCE']
...
export default function BirthdayWish() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center p-4">
      ...
      >
        {/* Birthday card */}
        <Card className="mx-auto overflow-hidden transition-all duration-300 [box-shadow:0px_0px_30px_black] ease-in-out font-[math] hover:shadow-2xl border-4 border-white bg-white rounded-lg shadow-lg">
          {/* Card header with birthday message */}
          <CardHeader className="text-center bg-gradient-to-r from-yellow-300 to-pink-300 p-4 rounded-t-lg">
            <CardTitle className="text-5xl font-bold text-black">Happy 18th Birthday!</CardTitle>
            <CardDescription className="text-3xl font-semibold text-orange-700">Sibtain Ali</CardDescription>
            <p className="text-lg text-orange-700">April 5th</p>
          </CardHeader>
          ...
          <CardFooter className="flex justify-center p-4">
            <Button 
              className="bg-black text-white hover:bg-gray-800 transition-all duration-300 rounded-lg shadow-md"
              onClick={celebrate}
